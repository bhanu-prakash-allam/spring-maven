...
<body>
	...
	<spring:form action="${pageContext.request.contextPath}/register-save" method="POST" modelAttribute="userDetails">
		...
		<ul>
			<li> <spring:checkbox path="roles" value="EMPLOYEE" label="EMPLOYEE"/></li>
			<li> <spring:checkbox path="roles" value="ADMIN" label="ADMIN"/></li>
			<li> <spring:checkbox path="roles" value="MANAGER" label="MANAGER"/></li>
		</ul>
		<br/>
		<br/>
		<input type="submit" value="Reegister">
