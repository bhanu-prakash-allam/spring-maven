package com.cts.springboot.boothibernet.controllers;
...
import com.cts.springboot.boothibernet.exception.StudentNotFoundException;
import com.cts.springboot.boothibernet.services.IProductService;
...
public class ProductRestController {
	...
	public ResponseEntity<Product> getById(@PathVariable Integer productId) {
		...
		if(product == null)
			throw new StudentNotFoundException("Student with id-" + productId + " not Found");
